        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalReadingMinutes = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "sparkles-outline", "Fantasy" },
                    { 2, "planet-outline", "Science Fiction" },
                    { 3, "heart-outline", "Romance" },
                    { 4, "flash-outline", "Thriller" },
                    { 5, "eye-outline", "Mystery" },
                    { 6, "time-outline", "Historical" },
                    { 7, "medical-outline", "Medical" }
                });
